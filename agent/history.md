...
Areas: skills/bill-feature-spec/content.md, skills/bill-feature-task/content.md, skills/bill-goal/content.md, README.md, docs/getting-started.md, docs/getting-started-for-teams.md, runtime-kotlin/runtime-domain/src/test/kotlin/skillbill/workflow/FeatureSpecSkillWiringContractTest.kt
...
- Description-string sweep dropped "GLM" from `skills/bill-create-skill/SKILL.md` runtime list and `skills/bill-feature-task/parsing_tolerance.md` runtime enumeration; README.md and `docs/getting-started.md` removed the GLM bullet/table row and added a short prose note: "Using GLM as a model in Claude Code? Skill Bill installs to the Claude Code commands directory — no separate target needed. GLM is a model, not a harness."
