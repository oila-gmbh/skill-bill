...
source-authored files. Shared sidecars such as `shell-ceremony.md` carry
project-overrides, execution-mode reporting, and telemetry rules.
...
reporting, generated wrapper section headings, or required sidecar references.
Those stay in generated `SKILL.md` wrappers or shared sidecars so the runtime
contract can be upgraded without rewriting authored business guidance.
