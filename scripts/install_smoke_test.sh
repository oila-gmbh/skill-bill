...
if [[ "$INTERACTIVE_OUTPUT" == *"Agents:         copilot, claude, codex, opencode, junie, cursor, zcode"* ]]; then
...
if [[ "$PIPED_OUTPUT" == *"Agents:         copilot, claude, codex, opencode, junie, cursor, zcode"* ]]; then
