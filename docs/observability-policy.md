...
- an audit-repair stage transition, checkpoint failure, no-progress pause, or compatibility recovery;
  records carry the workflow, cycle, stage, and bounded reason, never audit prose or repair bodies
