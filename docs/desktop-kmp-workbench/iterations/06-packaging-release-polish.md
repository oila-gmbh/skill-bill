...
This iteration belongs to the desktop KMP workbench spec in
`docs/desktop-kmp-workbench/README.md`. The workbench is an optional repo-based
...
`docs/desktop-kmp-workbench/README.md`.

## Goal

Make the desktop workbench easy to launch, document, and validate as an optional official Skill Bill surface.
...
- README or getting-started docs mention the desktop workbench without making it mandatory.
...
- Documentation should not imply that the workbench replaces CLI workflows; it complements them.
