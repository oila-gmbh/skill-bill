...
A maintainer can run the workbench locally and see the stable two-panel application frame without changing any Skill Bill repository content.
...
- `./gradlew :runtime-desktop:run` launches the workbench.
