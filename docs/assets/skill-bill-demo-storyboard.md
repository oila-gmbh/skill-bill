...
| 5 | 0:11–0:14 | Durable state | A line confirming the runtime's durable workflow update at a phase boundary; briefly show `skill-bill workflow latest` | "Durable state — crash anywhere, resume cleanly." |
