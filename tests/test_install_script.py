...
class InstallScriptTest(unittest.TestCase):
  ...
  def test_installs_custom_prefix_aliases_and_rewrites_skill_names(self) -> None:
    with tempfile.TemporaryDirectory() as temp_home:
      ...
      installed = self.installed_skills(temp_home)
      self.assertEqual(installed, alias_skill_names(BASE_SKILLS | GO_SKILLS, "acme"))
      ...
      self.assertIn("delegate to `acme-go-code-review`.", skill_text)
  ...
  def test_ignores_empty_platform_tokens(self) -> None:
    with tempfile.TemporaryDirectory() as temp_home:
      ...
      installed = self.installed_skills(temp_home)
      self.assertEqual(installed, BASE_SKILLS | GO_SKILLS | BACKEND_KOTLIN_SKILLS)
  ...
  def test_rerun_replaces_previous_custom_prefix_aliases(self) -> None:
    with tempfile.TemporaryDirectory() as temp_home:
      ...
      self.assertEqual(
        ...
        alias_skill_names(BASE_SKILLS | GO_SKILLS, "platform"),
      )
