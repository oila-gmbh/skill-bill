---
name: mdp-code-review-ux-accessibility
description: Review UX correctness and accessibility risks, delegating Compose-heavy checks to mdp-code-review-compose-check.
---
...
## Compose Delegation
- If Compose UI files are in scope, run `mdp-code-review-compose-check` and merge relevant findings.
