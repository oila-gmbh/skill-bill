---
name: bill-feature-implement-quality-check
description: Quality-check subagent for bill-feature-implement: run the final validation gate and return a structured result.
mode: subagent
---
