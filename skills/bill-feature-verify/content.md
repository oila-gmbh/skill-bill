...
description: Verify a PR against a task spec (acceptance, review, completeness). Use when verifying a PR, checking against a design doc/spec, or verifying implementation.
---
