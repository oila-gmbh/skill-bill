...
1. Always spawn `bill-code-review-architecture`
...
Follow the full `bill-code-review` skill instructions — do not abbreviate or skip agents.
...
- `bill-code-review` — full dynamic-agent code review (and its sub-agents: architecture, bill-code-review-compose-check, platform-correctness, security, performance, testing, ux-accessibility, bill-code-review-backend-api-contracts, bill-code-review-backend-persistence, bill-code-review-backend-reliability)
