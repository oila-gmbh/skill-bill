...
4. Create canonical skill file:
   - `$HOME/Development/mobile-development-plugin/skills/{slug}/SKILL.md`
...
5. Create symlink chain (primary → canonical, secondary agents → primary):
   a. Primary: `ln -s $HOME/Development/mobile-development-plugin/skills/{slug} {primary_path}/{slug}`
