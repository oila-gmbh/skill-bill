...
internal interface GoalRunnerManifestLookup {
  fun loadByIssueKey(issueKey: IssueKey, repoRoot: Path?): GoalRunnerManifestState?

  fun readByIssueKey(issueKey: IssueKey, repoRoot: Path?): GoalRunnerManifestState?

  fun readByIssueKeyIfPresent(issueKey: IssueKey, repoRoot: Path?): GoalRunnerManifestState?
...
internal interface GoalRunnerManifestPauseOps {
  ...
  fun requestPauseByIssueKey(issueKey: IssueKey, repoRoot: Path?): GoalRunnerPausePersistenceResult?
...
internal interface GoalRunnerManifestControlCommands {
  ...
  fun persistStopAfterSubtask(parentWorkflowId: String, subtaskId: SubtaskId): GoalRunnerControlState
