...
fun featureTaskRuntimeFinishedPayload(row: Map<String, Any?>, level: String): Map<String, Any?> =
  linkedMapOf<String, Any?>("session_id" to row.stringOrEmpty("session_id")).apply {
    ...
    put("audit_first_pass_convergence", row.intOrZero("audit_first_pass_convergence") == 1)
    put("audit_recurring_gap_count", row.intOrZero("audit_recurring_gap_count"))
    put("audit_new_gap_count", row.intOrZero("audit_new_gap_count"))
    put("audit_attempted_repair_item_count", row.intOrZero("audit_attempted_repair_item_count"))
    put("audit_resolved_repair_item_count", row.intOrZero("audit_resolved_repair_item_count"))
