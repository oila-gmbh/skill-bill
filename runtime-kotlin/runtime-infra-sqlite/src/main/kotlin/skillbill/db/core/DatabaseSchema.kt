  ...
  private val statements: List<String> =
    listOf(
      ...
      CREATE TABLE IF NOT EXISTS goal_shared_preplans (
        ...
        phase_output_contract_id TEXT NOT NULL, phase_output_contract_version TEXT NOT NULL CHECK (phase_output_contract_version IN ('0.2', '0.3', '0.4', '0.5')),
      ...
      CREATE TABLE IF NOT EXISTS goal_subtask_plans (
        ...
        phase_output_contract_version TEXT NOT NULL CHECK (phase_output_contract_version IN ('0.2', '0.3', '0.4', '0.5')), payload_sha256 TEXT NOT NULL,
