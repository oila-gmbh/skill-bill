...
import skillbill.telemetry.sync.telemetrySyncTarget
...
internal fun mapWorkflow(workflow: String): String = when (workflow) {
  ...
  "goal", "bill-feature-goal" -> "bill-feature-goal"
  "bill-feature-task", "feature-task-runtime" -> "feature-task-runtime"
