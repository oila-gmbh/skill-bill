...
@Inject
class FeatureTaskRuntimeRunLoopPhaseAttemptsBackoffGate {
  internal fun recordRejectionRegenerationEdge(
    runLoop: FeatureTaskRuntimeRunLoop,
    consumer: String,
  ): FeatureTaskRuntimeRunLoopPhaseAttemptsRetrySchedule.RecordRejectionRegenerationEdge? {
    ...
    return FeatureTaskRuntimeRunLoopPhaseAttemptsRetrySchedule.RecordRejectionRegenerationEdge(producer, edge)
  }
