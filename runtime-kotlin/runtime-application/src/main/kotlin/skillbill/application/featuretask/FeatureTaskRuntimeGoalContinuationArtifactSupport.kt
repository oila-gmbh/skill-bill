...
internal fun GoalSubtaskReviewState.canRecoverReviewBase(): Boolean =
  disposition == GoalSubtaskReviewDisposition.PENDING

internal fun GoalSubtaskReviewState.matches(
...
internal fun rawReviewResultError(fieldPath: String, reason: String): Nothing =
...
internal fun FeatureTaskRuntimeGoalContinuationArtifact?.compatibleWith(
