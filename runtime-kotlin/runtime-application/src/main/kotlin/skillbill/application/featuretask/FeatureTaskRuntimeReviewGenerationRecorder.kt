...
class FeatureTaskRuntimeReviewGenerationRecorder(
  ...
  override fun persistReviewGenerationInvalidation(workflowId: WorkflowId): Int? = database.transaction { unitOfWork ->
  ...
  override fun reconcileReviewGeneration(workflowId: WorkflowId): Int = database.transaction { unitOfWork ->
    val record = WorkflowFamily.TASK_RUNTIME.get(unitOfWork.workflowStates, workflowId)
  ...
  override fun fetchUnaddressedLedger(workflowId: WorkflowId): List<UnaddressedFinding> =
