...
class FeatureTaskRuntimeDecomposeTerminalRecorder(
  ...
  fun recordDecomposeTerminal(workflowId: WorkflowId, terminal: FeatureTaskRuntimeDecomposeTerminal): Boolean =
  ...
  fun loadDecomposeTerminal(workflowId: WorkflowId): FeatureTaskRuntimeDecomposeTerminal? =
