...
@Inject
class FeatureTaskRuntimeRunLoopPhaseAttemptsRetrySchedule {
  ...
  internal fun settleRecordRejection(
    ...
    return when (evidenceResolution) {
      is FeatureTaskRuntimeRunLoopPhaseAttemptsBackoffGate
        .RecordRejectionEvidenceResolution.Settled,
      -> evidenceResolution.outcome
      is FeatureTaskRuntimeRunLoopPhaseAttemptsBackoffGate.RecordRejectionEvidenceResolution.Ready ->
