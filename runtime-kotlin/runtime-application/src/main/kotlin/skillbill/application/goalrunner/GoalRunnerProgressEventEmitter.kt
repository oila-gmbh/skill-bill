...
class GoalRunnerProgressEventEmitter(
  ...
  private val resolveWorkflowId: () -> WorkflowId?,
  watermarkSeed: Int?,
  ...
  private fun logBestEffortFailure(emission: AgentRunProgressEmission, workflowId: WorkflowId, error: Throwable) {
    diagnostics.warning(
  ...
  private fun logBestEffortMissingWorkflow(emission: AgentRunProgressEmission, workflowId: WorkflowId) {
    diagnostics.warning(
