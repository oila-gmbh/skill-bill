...
internal const val NO_CURRENT_SUBTASK_ID = 0
internal const val NO_CURRENT_SUBTASK_ACTION = "none"
internal const val SUBTASK_ACTION_START = "start"
internal const val SUBTASK_ACTION_RESUME = "resume"
internal const val SUBTASK_STATUS_IN_PROGRESS = "in_progress"
internal const val SUBTASK_STATUS_PENDING = "pending"
internal const val SUBTASK_STATUS_COMPLETE = "complete"
internal const val SUBTASK_STATUS_SKIPPED = "skipped"

internal fun DecompositionManifest.isAtUnlaunchedBoundary(): Boolean {
...
internal fun DecompositionManifest.resetManifest(hard: Boolean): DecompositionManifest {
...
internal fun restartIntent(subtasks: List<DecompositionSubtask>): CurrentSubtaskIntent {
...
internal fun replanIntent(subtask: DecompositionSubtask): CurrentSubtaskIntent {
  val action = when {
...
internal fun DecompositionManifest.toResetSnapshot(): GoalRunnerResetSnapshot = GoalRunnerResetSnapshot(
  status = status,
