...
data class FeatureTaskRuntimeValidationGateRunRecord(
  ...
  constructor(
    ...
    outcome = requireNotNull(ValidationGateRunOutcome.fromWire(outcome)) { "Unknown validation gate outcome '$outcome'." },
    cacheMode = requireNotNull(ValidationGateCacheMode.fromWire(cacheMode)) { "Unknown validation gate cache mode '$cacheMode'." },
