...
internal class ProcessWaitLoop(
  ...
  private fun liveness(phase: String, reason: String, processState: GoalRunnerProcessState): AgentRunLivenessSnapshot =    declaredLiveness(phase, reason, processState, livenessState = null)
