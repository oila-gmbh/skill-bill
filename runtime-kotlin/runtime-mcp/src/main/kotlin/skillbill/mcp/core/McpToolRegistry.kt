    ...
    mapOf(
      ...
      "goal_prose_started" to objectSchema(
        ...
        properties = mapOf(
          ...
          "feature_name" to stringSchema(),
          "workflow_id" to stringSchema(),
          "subtask_total" to integerSchema,
          "resumed" to booleanSchema,
          "started_at" to stringSchema(),
        ),
      ),
      "goal_prose_subtask_finished" to objectSchema(
        required = listOf(
          "issue_key",
          "workflow_id",
          "subtask_id",
        ...
        properties = mapOf(
          ...
          "workflow_id" to stringSchema(),
          "subtask_id" to integerSchema,
          "subtask_name" to stringSchema(),
          "status" to stringSchema(enum = listOf("complete", "blocked", "skipped")),
          "started_at" to stringSchema(),
          "finished_at" to stringSchema(),
          "duration_ms" to integerSchema,
          "attempt_count" to integerSchema,
          "blocked_reason" to mapOf("type" to listOf("string", "null")),
        ),
      ),
      "goal_prose_finished" to objectSchema(
        required = listOf(
          "issue_key",
          "workflow_id",
          "status",
        ...
        properties = mapOf(
          "issue_key" to stringSchema(),
          "workflow_id" to stringSchema(),
          "status" to stringSchema(enum = listOf("completed", "blocked")),
          "started_at" to stringSchema(),
          "finished_at" to stringSchema(),
          "duration_ms" to integerSchema,
          "subtasks_complete" to integerSchema,
          "subtasks_blocked" to integerSchema,
          "subtasks_skipped" to integerSchema,
        ),
      ),
