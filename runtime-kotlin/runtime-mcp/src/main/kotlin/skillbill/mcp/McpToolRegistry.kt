...
object McpToolRegistry {
  ...
  private val descriptions: Map<String, String> =
    mapOf(
      ...
      "feature_implement_workflow_get" to "Fetch durable bill-feature-task workflow state.",
      ...
      "feature_implement_workflow_update" to "Update durable bill-feature-task workflow state.",
