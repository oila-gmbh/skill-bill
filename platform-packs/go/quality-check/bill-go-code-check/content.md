...
2. Discover the project's own quality commands from the build file, repository wrapper, and CI configuration, in that order, before falling back to Go defaults.
