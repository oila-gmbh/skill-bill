...
- Verify optional dependencies use `dep:name` and weak feature forwarding such as `name?/feature` where appropriate; reject accidental activation that expands builds or changes runtime behavior.
