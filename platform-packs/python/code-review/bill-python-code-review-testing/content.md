...
- Exercise interruption immediately after a durable checkpoint, then restart from recorded progress and assert cleanup plus duplicate-safe replay; happy-path worker tests cannot reveal skipped or repeated work after cancellation or process death.
