...
9. Live-product greps for `copilot` as a Skill Bill agent id are clean outside allowlisted archives (`..`, historical `../../../agent/history.md` / `../../../agent/decisions.md` bodies, this spec tree), leftover uninstall historical paths, and the Agnix `copilot = true` rule.
...
- Do not rewrite `..` or prior history/decision bodies. Historical delegated-review Copilot rows under `../../../docs/delegated-review` stay as SKILL-159 record.
